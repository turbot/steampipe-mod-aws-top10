...
select
  ...
  case
    when count(bucket_selector) > 0 then b.name || ' object-level data events logging enabled, through ' || s3_selectors.trail_name || ' trail.'
...
group by
  b.account_id, b.region, b.arn, b.name, s3_selectors.trail_name;